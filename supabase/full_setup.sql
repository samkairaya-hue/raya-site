-- Combined schema + seed for a fresh Supabase project.
-- Paste the whole file into Supabase SQL Editor and run once.

-- ===== supabase/migrations/20260721152613_91559822-9fea-4a78-8460-607281a7b08f.sql =====
...
-- ===== supabase/migrations/20260721152634_8eb15a4b-a1b2-48f1-a18f-2caf4113d3dc.sql =====
...
-- ===== supabase/migrations/20260721152645_4745fae3-ced8-4eef-a09d-959769c6a573.sql =====

REVOKE EXECUTE ON FUNCTION public.has_role(UUID, public.app_role) FROM PUBLIC, anon, authenticated;
REVOKE EXECUTE ON FUNCTION public.bootstrap_first_admin() FROM PUBLIC, anon, authenticated;

-- ===== supabase/migrations/20260721152707_dfa79da2-2582-4952-8751-d2802a29a297.sql =====
...
-- ===== supabase/migrations/20260721153834_7287c51d-418e-4a0d-8411-c427b3158342.sql =====
UPDATE auth.users SET email_confirmed_at = now() WHERE email = 'yaron_bs@yahoo.com' AND email_confirmed_at IS NULL;
-- ===== supabase/migrations/20260721161245_8a909c5d-551d-4d21-aad3-2b35bd4c0125.sql =====
GRANT EXECUTE ON FUNCTION public.has_role(uuid, public.app_role) TO authenticated, anon;
-- ===== supabase/migrations/20260722112234_e8b7bbfa-26b3-49d0-948a-b0a00cd580f8.sql =====
...
-- ===== supabase/migrations/20260722115037_4ef5f5cb-36fb-479c-93c2-23ce30497bea.sql =====
UPDATE public.site_content SET data = data || '{"site_title":"רעיה ברכה | EMID"}' WHERE key = 'settings' AND data->>'site_title' IS NULL;
-- ===== supabase/migrations/20260722115240_ec6e05e0-ae92-437e-a34c-bbac6b8775b4.sql =====
